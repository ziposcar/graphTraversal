...
def getUrl():
    ...
    url="http://127.0.0.1/phpaaCMS_{}/admin/login.php" #phpCSS
    return url
...
def getInstrumentFile():
    ...
    file = "D:\\WandS\\Graduation_Project\\webapp instrrument\\phpaaCMS\\admin\\b.txt"
    file2 = "D:\\WandS\\Graduation_Project\\webapp instrrument\\phpaaCMS\\admin\\bbb.txt"
    redis_path = "phpaaCMS_{}"
...
def getPopParameter():
    ...
    multi_process_count = 6  # phpcss sensitive path has 18
    pc = 0.8
    pm = 0.9
    Max = 2000
